...
def max_nkll(x, data, n_sim=10000):
    '''Función que toma una serie de parámetros y los ajusta siguiendo un modelo que estima la confianza
       como la magnitud de la distribución posterior correspondiente a la opción más probable. Devuelve el negativo del 
    ...
    ## Probabilidad posterior máxima para cada simulación de cada trial:
    maximos = np.amax(probs, axis=1)
